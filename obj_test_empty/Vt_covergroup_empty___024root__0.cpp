...
void Vt_covergroup_empty___024root___eval_initial(Vt_covergroup_empty___024root* vlSelf) {
    ...
    // Body
    Vt_covergroup_empty_t___eval_initial__TOP__t__Vtiming__0((&vlSymsp->TOP__t));
}
...
void Vt_covergroup_empty___024root___eval_act(Vt_covergroup_empty___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vt_covergroup_empty___024root___eval_act\n"); );
    Vt_covergroup_empty__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VactTriggered[0U])) {
        Vt_covergroup_empty_t___act_sequent__TOP__t__0((&vlSymsp->TOP__t));
    }
}
...
void Vt_covergroup_empty___024root___timing_commit(Vt_covergroup_empty___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vt_covergroup_empty___024root___timing_commit\n"); );
    Vt_covergroup_empty__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((! (1ULL & vlSelfRef.__VactTriggered[0U]))) {
        vlSelfRef.__VtrigSched_hc5d4c2fc__0.commit(
                                                   "@(posedge clk)");
    }
}
...
void Vt_covergroup_empty___024root___timing_resume(Vt_covergroup_empty___024root* vlSelf) {
    ...
    // Body
    if ((1ULL & vlSelfRef.__VactTriggered[0U])) {
        vlSelfRef.__VtrigSched_hc5d4c2fc__0.resume(
                                                   "@(posedge clk)");
    }
...
bool Vt_covergroup_empty___024root___eval_phase__act(Vt_covergroup_empty___024root* vlSelf) {
    ...
    Vt_covergroup_empty___024root___timing_commit(vlSelf);
    ...
    if (__VactExecute) {
        ...
        Vt_covergroup_empty___024root___eval_act(vlSelf);
    }
