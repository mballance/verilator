...
VL_ATTR_COLD void Vt_covergroup_empty_std___configure_coverage(Vt_covergroup_empty_std* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[22]), first, "/home/mballance/projects/verilator/verilator-funccov/include/verilated_std.sv", 243, 16, "", "v_line/std", "block", "243-244");
}
