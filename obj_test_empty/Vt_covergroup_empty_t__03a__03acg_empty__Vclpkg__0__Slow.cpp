...
VL_ATTR_COLD void Vt_covergroup_empty_t__03a__03acg_empty__Vclpkg___configure_coverage(Vt_covergroup_empty_t__03a__03acg_empty__Vclpkg* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[23]), first, "test_regress/t/t_covergroup_empty.v", 17, 4, "", "v_line/cg_empty", "block", "17");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[24]), first, "test_regress/t/t_covergroup_empty.v", 17, 15, "", "v_line/cg_empty", "block", "17");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[25]), first, "test_regress/t/t_covergroup_empty.v", 17, 15, "", "v_line/cg_empty", "block", "17");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[26]), first, "test_regress/t/t_covergroup_empty.v", 17, 15, "", "v_line/cg_empty", "block", "17");
