...
Vt_covergroup_negative_ranges__Syms::Vt_covergroup_negative_ranges__Syms(VerilatedContext* contextp, const char* namep, Vt_covergroup_negative_ranges* modelp)
...
Vt_covergroup_negative_ranges__Syms::~Vt_covergroup_negative_ranges__Syms() {
    // Tear down scopes
