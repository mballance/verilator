...
Vt_funccov_auto_bins__Syms::Vt_funccov_auto_bins__Syms(VerilatedContext* contextp, const char* namep, Vt_funccov_auto_bins* modelp)
...
Vt_funccov_auto_bins__Syms::~Vt_funccov_auto_bins__Syms() {
    // Tear down scopes
