...
#ifndef VERILATED_VTEST_PARTIAL_COVERAGE_STD_H_
#define VERILATED_VTEST_PARTIAL_COVERAGE_STD_H_  // guard
...
struct Vtest_partial_coverage_vl_covergroup_options_t__struct__0 {
    ...
    bool operator==(const Vtest_partial_coverage_vl_covergroup_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vtest_partial_coverage_vl_covergroup_options_t__struct__0> : public std::true_type {};
struct Vtest_partial_coverage_vl_covergroup_type_options_t__struct__0 {
    IData/*31:0*/ __PVT__weight;
    IData/*31:0*/ __PVT__goal;
    std::string __PVT__comment;
    ...
    bool operator==(const Vtest_partial_coverage_vl_covergroup_type_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vtest_partial_coverage_vl_covergroup_type_options_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) Vtest_partial_coverage_std final {
  public:
    ...
    // CONSTRUCTORS
    Vtest_partial_coverage_std();
    ~Vtest_partial_coverage_std();
    void ctor(Vtest_partial_coverage__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtest_partial_coverage_std);
...
std::string VL_TO_STRING(const Vtest_partial_coverage_vl_covergroup_options_t__struct__0& obj);
std::string VL_TO_STRING(const Vtest_partial_coverage_vl_covergroup_type_options_t__struct__0& obj);
