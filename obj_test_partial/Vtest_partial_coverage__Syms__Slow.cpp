...
Vtest_partial_coverage__Syms::Vtest_partial_coverage__Syms(VerilatedContext* contextp, const char* namep, Vtest_partial_coverage* modelp)
...
Vtest_partial_coverage__Syms::~Vtest_partial_coverage__Syms() {
    // Tear down scopes
