...
module t;
    ...
    covergroup cg;
        ...
        // 3-way cross creates 2×2×2 = 8 bins
        abc: cross a, b, c;
    endgroup
    ...
    initial begin
        ...
        addr = 0; cmd = 0; data = 1; cg_inst.sample(); // low×read×one
        addr = 0; cmd = 1; data = 0; cg_inst.sample(); // low×write×zero
        addr = 0; cmd = 1; data = 1; cg_inst.sample(); // low×write×one
        addr = 2; cmd = 0; data = 0; cg_inst.sample(); // high×read×zero
        addr = 2; cmd = 0; data = 1; cg_inst.sample(); // high×read×one
        addr = 2; cmd = 1; data = 0; cg_inst.sample(); // high×write×zero
