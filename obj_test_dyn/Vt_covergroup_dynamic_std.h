...
#ifndef VERILATED_VT_COVERGROUP_DYNAMIC_STD_H_
#define VERILATED_VT_COVERGROUP_DYNAMIC_STD_H_  // guard
...
struct Vt_covergroup_dynamic_vl_covergroup_options_t__struct__0 {
    ...
    bool operator==(const Vt_covergroup_dynamic_vl_covergroup_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vt_covergroup_dynamic_vl_covergroup_options_t__struct__0> : public std::true_type {};
struct Vt_covergroup_dynamic_vl_covergroup_type_options_t__struct__0 {
    IData/*31:0*/ __PVT__weight;
    IData/*31:0*/ __PVT__goal;
    std::string __PVT__comment;
    ...
    bool operator==(const Vt_covergroup_dynamic_vl_covergroup_type_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vt_covergroup_dynamic_vl_covergroup_type_options_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) Vt_covergroup_dynamic_std final {
  public:
    ...
    // CONSTRUCTORS
    Vt_covergroup_dynamic_std();
    ~Vt_covergroup_dynamic_std();
    void ctor(Vt_covergroup_dynamic__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vt_covergroup_dynamic_std);
...
std::string VL_TO_STRING(const Vt_covergroup_dynamic_vl_covergroup_options_t__struct__0& obj);
std::string VL_TO_STRING(const Vt_covergroup_dynamic_vl_covergroup_type_options_t__struct__0& obj);
