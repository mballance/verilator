...
Vt_covergroup_dynamic__Syms::Vt_covergroup_dynamic__Syms(VerilatedContext* contextp, const char* namep, Vt_covergroup_dynamic* modelp)
...
Vt_covergroup_dynamic__Syms::~Vt_covergroup_dynamic__Syms() {
    // Tear down scopes
