...
void Vt_covergroup_trans_restart___024root___eval(Vt_covergroup_trans_restart___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vt_covergroup_trans_restart___024root___eval\n"); );
...
void Vt_covergroup_trans_restart___024root___eval_debug_assertions(Vt_covergroup_trans_restart___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vt_covergroup_trans_restart___024root___eval_debug_assertions\n"); );
    Vt_covergroup_trans_restart__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}
#endif  // VL_DEBUG
