...
Vt_covergroup_trans_restart__Syms::Vt_covergroup_trans_restart__Syms(VerilatedContext* contextp, const char* namep, Vt_covergroup_trans_restart* modelp)
...
Vt_covergroup_trans_restart__Syms::~Vt_covergroup_trans_restart__Syms() {
    // Tear down scopes
