...
VL_ATTR_COLD void Vt_covergroup_cross_small_std___ctor_var_reset(Vt_covergroup_cross_small_std* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vt_covergroup_cross_small_std___ctor_var_reset\n"); );
