...
Vt_covergroup_cross_small__Syms::Vt_covergroup_cross_small__Syms(VerilatedContext* contextp, const char* namep, Vt_covergroup_cross_small* modelp)
...
Vt_covergroup_cross_small__Syms::~Vt_covergroup_cross_small__Syms() {
    // Tear down scopes
