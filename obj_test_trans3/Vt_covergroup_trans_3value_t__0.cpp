...
void Vt_covergroup_trans_3value_t___ico_sequent__TOP__t__0(Vt_covergroup_trans_3value_t* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vt_covergroup_trans_3value_t___ico_sequent__TOP__t__0\n"); );
...
void Vt_covergroup_trans_3value_t___nba_sequent__TOP__t__0(Vt_covergroup_trans_3value_t* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vt_covergroup_trans_3value_t___nba_sequent__TOP__t__0\n"); );
    Vt_covergroup_trans_3value__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    double __Vtask_get_inst_coverage__Vtcwrap_1_2__4__Vfuncout;
    __Vtask_get_inst_coverage__Vtcwrap_1_2__4__Vfuncout = 0;
    IData/*31:0*/ __Vdly__cyc;
    __Vdly__cyc = 0;
    // Body
    __Vdly__cyc = vlSelfRef.__PVT__cyc;
    __Vdly__cyc = ((IData)(1U) + vlSelfRef.__PVT__cyc);
    VL_NULL_CHECK(vlSelfRef.__PVT__cg_inst, "test_regress/t/t_covergroup_trans_3value.v", 28)->__VnoInFunc_sample(vlSymsp);
    if ((0U == vlSelfRef.__PVT__cyc)) {
        ...
        if ((([&]() {
            ...
            VL_FINISH_MT("test_regress/t/t_covergroup_trans_3value.v", 40, "");
            ++(vlSymsp->__Vcoverage[15]);
        } else {
            VL_WRITEF_NX("ERROR: Expected 100%% coverage, got %f%%\n",0,
                         64,([&]() {
                            VL_NULL_CHECK(vlSelfRef.__PVT__cg_inst, "test_regress/t/t_covergroup_trans_3value.v", 42)
                             ->__VnoInFunc_get_inst_coverage__Vtcwrap_1_2(vlSymsp, __Vtask_get_inst_coverage__Vtcwrap_1_2__4__Vfuncout);
                        }(), __Vtask_get_inst_coverage__Vtcwrap_1_2__4__Vfuncout));
            VL_STOP_MT("test_regress/t/t_covergroup_trans_3value.v", 43, "");
        }
        ++(vlSymsp->__Vcoverage[16]);
    }
    if (VL_UNLIKELY((VL_LTS_III(32, 0x0000000aU, vlSelfRef.__PVT__cyc)))) {
        VL_WRITEF_NX("ERROR: Test timed out\n",0);
        VL_STOP_MT("test_regress/t/t_covergroup_trans_3value.v", 51, "");
    } else {
