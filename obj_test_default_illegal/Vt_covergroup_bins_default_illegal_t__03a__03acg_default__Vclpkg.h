...
#ifndef VERILATED_VT_COVERGROUP_BINS_DEFAULT_ILLEGAL_T__03A__03ACG_DEFAULT__VCLPKG_H_
#define VERILATED_VT_COVERGROUP_BINS_DEFAULT_ILLEGAL_T__03A__03ACG_DEFAULT__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vt_covergroup_bins_default_illegal_t__03a__03acg_default__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vt_covergroup_bins_default_illegal_t__03a__03acg_default__Vclpkg();
    ~Vt_covergroup_bins_default_illegal_t__03a__03acg_default__Vclpkg();
    void ctor(Vt_covergroup_bins_default_illegal__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vt_covergroup_bins_default_illegal_t__03a__03acg_default__Vclpkg);
...
class Vt_covergroup_bins_default_illegal_t__03a__03acg_default : public virtual VlClass {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT____Vcov__special;
    IData/*31:0*/ __PVT____Vcov__others;
  ...
  public:
    Vt_covergroup_bins_default_illegal_t__03a__03acg_default(Vt_covergroup_bins_default_illegal__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vt_covergroup_bins_default_illegal_t__03a__03acg_default() {}
};
