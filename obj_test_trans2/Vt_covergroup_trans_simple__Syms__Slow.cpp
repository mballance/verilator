...
Vt_covergroup_trans_simple__Syms::Vt_covergroup_trans_simple__Syms(VerilatedContext* contextp, const char* namep, Vt_covergroup_trans_simple* modelp)
...
Vt_covergroup_trans_simple__Syms::~Vt_covergroup_trans_simple__Syms() {
    // Tear down scopes
