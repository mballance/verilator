...
#ifndef VERILATED_VT_COVERGROUP_AUTOBINS_T__03A__03ACG3__VCLPKG_H_
#define VERILATED_VT_COVERGROUP_AUTOBINS_T__03A__03ACG3__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vt_covergroup_autobins_t__03a__03acg3__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vt_covergroup_autobins_t__03a__03acg3__Vclpkg();
    ~Vt_covergroup_autobins_t__03a__03acg3__Vclpkg();
    void ctor(Vt_covergroup_autobins__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vt_covergroup_autobins_t__03a__03acg3__Vclpkg);
...
class Vt_covergroup_autobins_t__03a__03acg3 : public virtual VlClass {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT____Vcov_cp_data3_reserved;
  ...
  public:
    Vt_covergroup_autobins_t__03a__03acg3(Vt_covergroup_autobins__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vt_covergroup_autobins_t__03a__03acg3() {}
};
