...
#ifndef VERILATED_VT_COVERGROUP_AUTOBINS_T__03A__03ACG5__VCLPKG_H_
#define VERILATED_VT_COVERGROUP_AUTOBINS_T__03A__03ACG5__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vt_covergroup_autobins_t__03a__03acg5__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vt_covergroup_autobins_t__03a__03acg5__Vclpkg();
    ~Vt_covergroup_autobins_t__03a__03acg5__Vclpkg();
    void ctor(Vt_covergroup_autobins__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vt_covergroup_autobins_t__03a__03acg5__Vclpkg);
...
class Vt_covergroup_autobins_t__03a__03acg5 : public virtual VlClass {
  public:
  ...
  public:
    Vt_covergroup_autobins_t__03a__03acg5(Vt_covergroup_autobins__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vt_covergroup_autobins_t__03a__03acg5() {}
};
