...
#ifndef VERILATED_VT_COVERGROUP_AUTOBINS_T__03A__03ACG4__VCLPKG_H_
#define VERILATED_VT_COVERGROUP_AUTOBINS_T__03A__03ACG4__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vt_covergroup_autobins_t__03a__03acg4__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vt_covergroup_autobins_t__03a__03acg4__Vclpkg();
    ~Vt_covergroup_autobins_t__03a__03acg4__Vclpkg();
    void ctor(Vt_covergroup_autobins__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vt_covergroup_autobins_t__03a__03acg4__Vclpkg);
...
class Vt_covergroup_autobins_t__03a__03acg4 : public virtual VlClass {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT____Vcov_cp_data2___auto_0_;
    IData/*31:0*/ __PVT____Vcov_cp_data2___auto_1_;
    IData/*31:0*/ __PVT____Vcov_cp_data2___auto_2_;
    IData/*31:0*/ __PVT____Vcov_cp_data2___auto_3_;
  ...
  public:
    Vt_covergroup_autobins_t__03a__03acg4(Vt_covergroup_autobins__Syms* __restrict vlSymsp);
    std::string to_string() const;
    std::string to_string_middle() const;
    ~Vt_covergroup_autobins_t__03a__03acg4() {}
};
