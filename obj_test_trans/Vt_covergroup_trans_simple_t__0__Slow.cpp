...
VL_ATTR_COLD void Vt_covergroup_trans_simple_t___configure_coverage(Vt_covergroup_trans_simple_t* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[16]), first, "test_regress/t/t_covergroup_trans_simple.v", 46, 8, "", "v_line/t", "else", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[17]), first, "test_regress/t/t_covergroup_trans_simple.v", 25, 4, "", "v_line/t", "block", "25-26,28");
}
