...
Vt_funccov_bin_counts__Syms::Vt_funccov_bin_counts__Syms(VerilatedContext* contextp, const char* namep, Vt_funccov_bin_counts* modelp)
...
Vt_funccov_bin_counts__Syms::~Vt_funccov_bin_counts__Syms() {
    // Tear down scopes
